...
/*
  Using an if statement and a comparison operator, create code that will check if Amy and Brittani were born
   in the same year. If they were, console.log 'Amy & Brittani were born in the same year'.
...
/*
  Using an if statement and a comparison operator, create code that will log a suggestion on what type of clothes
...
} else if (rain === false) {console.log ("Wear a light jacket.")
} else if (temperature <=60 && rain === false) {
  console.log ("Wear a rain coat and warm layers.")
}
